  ...
  return (
    <section id="hero" className="relative min-h-screen pt-24 pb-12 flex flex-col justify-center overflow-hidden bg-[var(--bg)]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-20 dark:opacity-10">
        <svg className="absolute top-10 left-10 w-96 h-96 text-[var(--accent)] animate-pulse" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <path fill="none" stroke="currentColor" strokeWidth="1.5" d="M 0,100 C 50,150 150,50 200,100" />
          <path fill="none" stroke="currentColor" strokeWidth="1" d="M 20,20 C 80,180 120,20 180,180" />
        </svg>
        <svg className="absolute bottom-10 right-10 w-96 h-96 text-[var(--accent-secondary)] animate-pulse" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <path fill="none" stroke="currentColor" strokeWidth="1.5" d="M 0,50 C 100,150 100,50 200,150" />
        </svg>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-20 relative z-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center z-10 pt-10 lg:pt-0">
          ...
          >
            Handcrafted <br />
            <span className="italic text-[var(--accent-secondary)] font-normal">Soft Luxury</span>
          </motion.h1>
          ...
          >
            Explore our organic crochet lifestyle collection. Every piece is meticulously handcrafted with warm, sustainable yarn to bring calm and luxury into your everyday life.
          </motion.p>
